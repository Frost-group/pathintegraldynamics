...
function SFPlotDimer(fname)
    ...
    Gnuplot.save("Results/populations-rubrene-troisi-heom.png", term="pngcairo size 550,350 fontscale 0.8")

    #savefig("Dimer-TTM-Populations.png")
end

SFPlotDimer("Results/HEOM-SF-populations-Troisi-Rubrene-Lmax-7.stdout")
