...
kt2t1 = Marcus(real.(H[5,6]), real.(H[5, 5] - H[6,6]), β, λ[3])   
    ...
    println("$kf1f2 $kf2f1 $kf1c1 $kc1f1 $kf1c2 $kc2f1 $kf2c1 $kc1f2 $kf2c2  $kc2f2  $kc1t1  $kt1c1 $kc1t2 $kt2c1 $kc2t1 $kt1c2 $kc2t2 $kt2c2 $kf1t1 $kt1f1 $kf1t2 $kt2f1 $kf2t1 $kt1f2 $kf2t2 $kt2f2 $kt1t2 $kt2t1")
    println(-(kf1f2 + kf1c1 + kf1c2 + kf1t1 + kf1t2))
...
function func_semi2!(du, u, p, t)
    du[1]=-(p.kf1f2 + p.kf1c1 + p.kf1c2+ p.kf1t1+p.kf1t2)*u[1]+p.kf2f1*u[2]+p.kc1f1*u[3]+p.kc2f1*u[4]+p.kt1f1*u[5]+p.kt2f1*u[6]
    du[2]=p.kf1f2*u[1] -(p.kf2f1 + p.kf2c1+ p.kf2c2 + p.kf2t1+p.kf2t2)*u[2]+ p.kc1f2*u[3]+ p.kc2f2*u[4]+ p.kt1f2*u[5]+ p.kt2f2*u[6]
    du[3]=p.kf1c1*u[1]+p.kf2c1*u[2] -(p.kc1f1+p.kc1f2+p.kc1t1+p.kc1t2)*u[3]+ p.kt1c1*u[5]+p.kt2c1*u[6]
    du[4]=p.kf1c2*u[1]+p.kf2c2*u[2] -(p.kc2f1+p.kc2f2+p.kc2t1+p.kc2t2)*u[4]+ p.kt1c2*u[5]+p.kt2c2*u[6]
